...
public class AdpaterRevenue extends BaseExpandableListAdapter implements Filterable{
    Context context;
    List<String> title;
    HashMap<String, List<String>> toppic;
    List<String> listTemp;

    public AdpaterRevenue(Context context, List<String> title, HashMap<String, List<String>> toppic) {
